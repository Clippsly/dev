function visitModeratedPage() {
    ...
    fetch(
        'https://api.clippsly.com/endpoints/moderation/account-status',
        {
            method: 'POST',
            headers: {
    ...
    document
        ...
        ?.addEventListener('submit', function (event) {
            ...
            fetch(
                'https://api.clippsly.com/endpoints/moderation/account-reactivation',
                {
                    method: 'POST',
                    headers: {
                        Authorization: `Bearer ${sessionToken}`,
