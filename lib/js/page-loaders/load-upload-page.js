function visitUploadPage() {
    ...
    document.querySelector('.container').innerHTML = `
        <div class="middle-float">
            <form id="submission-form" method="POST" enctype="multipart/form-data">
                <h1>Upload (Beta)</h1>
                <details>
                    <summary>Release Settings</summary>
                ...
                <details>
                    ...
                    <div id="tracks-section">
                        <button type="button" class="primary" id="add-track-btn">Add Track</button>
    ...
    $('#submission-form').submit(function (event) {
        ...
        fetch(
            'https://api.clippsly.com/endpoints/functions/track-upload',
            {
                method: 'POST',
                body: formData,
                headers: {
