...
function submitUsernameForm(event) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            axios.post('https://api.clippsly.com/endpoints/settings/update-user', formData, {
                headers: {
                    'Authorization': `Bearer ${sessionToken}`,
...
function submitDisplaynameForm(event) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            axios.post('https://api.clippsly.com/endpoints/settings/update-display', formData, {
                headers: {
                    'Authorization': `Bearer ${sessionToken}`,
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
...
function submitDescriptionForm(event) {
    ...
    axios.post('https://api.clippsly.com/endpoints/settings/update-description', formData, {
        headers: {
            'Authorization': `Bearer ${sessionToken}`,
            'Accept': 'application/json',
            'Content-Type': 'application/json'
...
function submitAvatarForm(event) {
    ...
    axios.post('https://api.clippsly.com/endpoints/settings/update-avatar', formData, {
        headers: {
            'Authorization': `Bearer ${sessionToken}`
        }
    })
...
function submitBannerForm(event) {
    ...
    axios.post('https://api.clippsly.com/endpoints/settings/update-banner', formData, {
        headers: {
            'Authorization': `Bearer ${sessionToken}`
        }
    })
...
function accountAction(action) {
    ...
    const sendApiRequest = () => {
        const apiUrl = 'https://api.clippsly.com/endpoints/moderation/account-deactivation';
