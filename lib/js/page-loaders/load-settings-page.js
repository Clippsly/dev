...
function submitUsernameForm(event) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            fetch("https://api.clippsly.com/endpoints/settings/update-user", {
                method: "POST",
                body: formData,
                headers: {
                    Authorization: `Bearer ${sessionToken}`,
...
function submitDisplaynameForm(event) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            fetch("https://api.clippsly.com/endpoints/settings/update-display", {
                method: "POST",
                body: formData,
                headers: {
                    Authorization: `Bearer ${sessionToken}`,
...
function submitDescriptionForm(event) {
    ...
    fetch("https://api.clippsly.com/endpoints/settings/update-description", {
        method: "POST",
        body: formData,
        headers: {
            Authorization: `Bearer ${sessionToken}`,
...
function submitAvatarForm(event) {
    ...
    fetch("https://api.clippsly.com/endpoints/settings/update-avatar", {
        method: "POST",
        body: formData,
        headers: {
            Authorization: `Bearer ${sessionToken}`,
...
function submitBannerForm(event) {
    ...
    fetch("https://api.clippsly.com/endpoints/settings/update-banner", {
        method: "POST",
        body: formData,
        headers: {
            Authorization: `Bearer ${sessionToken}`,
