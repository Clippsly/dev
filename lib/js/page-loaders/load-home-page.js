            ...
            <div class="track">
                <div class="cover">
                    <a href="/track/${track.ID}" onclick="visitTrackPage(${track.ID})">
                        <img src="${track.ArtCover ? track.ArtCover : 'https://cdn.clippsly.com/brand_assets/icons/default-artist.png'}" 
                            alt="Track Cover" 
                ...
                <div class="details">
                    <a href="/users/${track.releaseAuthor.authorUsername}" onclick="visitUserProfile('${track.releaseAuthor.authorUsername}')">
                        <img src="${track.releaseAuthor.authorAvatar ? track.releaseAuthor.authorAvatar : 'https://cdn.clippsly.com/brand_assets/icons/default-artist.png'}" 
                            alt="Profile Picture" 
                            class="profile-pic" 
                            onerror="this.onerror=null; this.src='https://cdn.clippsly.com/brand_assets/icons/default-artist.png';">
                    </a>
