function loadHomePage() {
    ...
    container.innerHTML = `
        <div class="side-align" data-controller="trackLayout">
            <h2>Latest Tracks</h2>
            <div data-trackLayout-target="latest" class="track-carousel">
            <!-- Skeleton -->
            <div class="track skeleton"><div class="track-cover skeleton-load-bg"></div><div class="track-metadata"><div class="avatar skeleton-load-bg"></div><div class="track-info"><span class="skeleton-load-bg">wwwwwwwwwww</span><span class="skeleton-load-bg">wwwwwww</span></div></div></div><div class="track skeleton"><div class="track-cover skeleton-load-bg"></div><div class="track-metadata"><div class="avatar skeleton-load-bg"></div><div class="track-info"><span class="skeleton-load-bg">wwwwwwwwwww</span><span class="skeleton-load-bg">wwwwwww</span></div></div></div><div class="track skeleton"><div class="track-cover skeleton-load-bg"></div><div class="track-metadata"><div class="avatar skeleton-load-bg"></div><div class="track-info"><span class="skeleton-load-bg">wwwwwwwwwww</span><span class="skeleton-load-bg">wwwwwww</span></div></div></div><div class="track skeleton"><div class="track-cover skeleton-load-bg"></div><div class="track-metadata"><div class="avatar skeleton-load-bg"></div><div class="track-info"><span class="skeleton-load-bg">wwwwwwwwwww</span><span class="skeleton-load-bg">wwwwwww</span></div></div></div>
            </div>
            
            <h2>Recommended Tracks</h2>
            <div data-trackLayout-target="recommended" class="track-list">
            <!-- Skeleton -->
            <div class="track skeleton"><div class="track-cover skeleton-load-bg"></div><div class="track-metadata"><div class="avatar skeleton-load-bg"></div><div class="track-info"><span class="skeleton-load-bg">wwwwwwwwwww</span><span class="skeleton-load-bg">wwwwwww</span></div></div></div><div class="track skeleton"><div class="track-cover skeleton-load-bg"></div><div class="track-metadata"><div class="avatar skeleton-load-bg"></div><div class="track-info"><span class="skeleton-load-bg">wwwwwwwwwww</span><span class="skeleton-load-bg">wwwwwww</span></div></div></div><div class="track skeleton"><div class="track-cover skeleton-load-bg"></div><div class="track-metadata"><div class="avatar skeleton-load-bg"></div><div class="track-info"><span class="skeleton-load-bg">wwwwwwwwwww</span><span class="skeleton-load-bg">wwwwwww</span></div></div></div><div class="track skeleton"><div class="track-cover skeleton-load-bg"></div><div class="track-metadata"><div class="avatar skeleton-load-bg"></div><div class="track-info"><span class="skeleton-load-bg">wwwwwwwwwww</span><span class="skeleton-load-bg">wwwwwww</span></div></div></div><div class="track skeleton"><div class="track-cover skeleton-load-bg"></div><div class="track-metadata"><div class="avatar skeleton-load-bg"></div><div class="track-info"><span class="skeleton-load-bg">wwwwwwwwwww</span><span class="skeleton-load-bg">wwwwwww</span></div></div></div><div class="track skeleton"><div class="track-cover skeleton-load-bg"></div><div class="track-metadata"><div class="avatar skeleton-load-bg"></div><div class="track-info"><span class="skeleton-load-bg">wwwwwwwwwww</span><span class="skeleton-load-bg">wwwwwww</span></div></div></div><div class="track skeleton"><div class="track-cover skeleton-load-bg"></div><div class="track-metadata"><div class="avatar skeleton-load-bg"></div><div class="track-info"><span class="skeleton-load-bg">wwwwwwwwwww</span><span class="skeleton-load-bg">wwwwwww</span></div></div></div><div class="track skeleton"><div class="track-cover skeleton-load-bg"></div><div class="track-metadata"><div class="avatar skeleton-load-bg"></div><div class="track-info"><span class="skeleton-load-bg">wwwwwwwwwww</span><span class="skeleton-load-bg">wwwwwww</span></div></div></div><div class="track skeleton"><div class="track-cover skeleton-load-bg"></div><div class="track-metadata"><div class="avatar skeleton-load-bg"></div><div class="track-info"><span class="skeleton-load-bg">wwwwwwwwwww</span><span class="skeleton-load-bg">wwwwwww</span></div></div></div><div class="track skeleton"><div class="track-cover skeleton-load-bg"></div><div class="track-metadata"><div class="avatar skeleton-load-bg"></div><div class="track-info"><span class="skeleton-load-bg">wwwwwwwwwww</span><span class="skeleton-load-bg">wwwwwww</span></div></div></div><div class="track skeleton"><div class="track-cover skeleton-load-bg"></div><div class="track-metadata"><div class="avatar skeleton-load-bg"></div><div class="track-info"><span class="skeleton-load-bg">wwwwwwwwwww</span><span class="skeleton-load-bg">wwwwwww</span></div></div></div><div class="track skeleton"><div class="track-cover skeleton-load-bg"></div><div class="track-metadata"><div class="avatar skeleton-load-bg"></div><div class="track-info"><span class="skeleton-load-bg">wwwwwwwwwww</span><span class="skeleton-load-bg">wwwwwww</span></div></div></div><div class="track skeleton"><div class="track-cover skeleton-load-bg"></div><div class="track-metadata"><div class="avatar skeleton-load-bg"></div><div class="track-info"><span class="skeleton-load-bg">wwwwwwwwwww</span><span class="skeleton-load-bg">wwwwwww</span></div></div></div><div class="track skeleton"><div class="track-cover skeleton-load-bg"></div><div class="track-metadata"><div class="avatar skeleton-load-bg"></div><div class="track-info"><span class="skeleton-load-bg">wwwwwwwwwww</span><span class="skeleton-load-bg">wwwwwww</span></div></div></div><div class="track skeleton"><div class="track-cover skeleton-load-bg"></div><div class="track-metadata"><div class="avatar skeleton-load-bg"></div><div class="track-info"><span class="skeleton-load-bg">wwwwwwwwwww</span><span class="skeleton-load-bg">wwwwwww</span></div></div></div>
            </div>
        </div>
...
function fetchTracks() {
    const latestTracksContainer =
        document.getElementById('latest-tracks')
    const recommendedTracksContainer = document.getElementById(
        'recommended-tracks'
    )
    ...
    fetch('https://api.clippsly.com/endpoints/functions/home-page')
        ...
        .then((data) => {
            ...
            latestTracksContainer.innerHTML =
                generateTrackHTML(latestTracks)
            recommendedTracksContainer.innerHTML =
                generateTrackHTML(recommendedTracks)
        })
        .catch((error) => {
...
//                     ? track.releaseAuthor.authorDisplay.substring(
//                           0,
//                           10
//                       ) + '...'
...
//                     <a href="/track/${
//                         track.ID
//                     }" onclick="visitTrackPage(${track.ID})">
//                         <img src="${
//                             track.ArtCover
//                                 ? track.ArtCover
...
//                     </a>
//                     <div class="play-button" onclick="playRequestedTrack(${
//                         track.ID
//                     })">
//                         <span>
