        ...
        .then((track) => {
            ...
            <div class="track-details">
                ...
                track.releaseAuthor.authorUsername
                            ...
                            ${track.releaseAuthor.authorDisplay} ${verifiedBadge}<span class="author-username">@${
                track.releaseAuthor.authorUsername
            }</span>
                        </a>
                    </p>
                    ...
                    <div class="${commentClasses}">
                        ...
                        <div class="comment-content">
                            <p class="comment-author">
                                <a href="/users/${comment.commentAuthorUsername}" onclick="visitUserProfile('${
                        comment.commentAuthorUsername
                    }')">
                                    ${comment.commentAuthorDisplay} ${verifiedBadge} <span class="comment-username">@${
                        comment.commentAuthorUsername
                    }</span>
                                </a>
                            </p>
                            <p class="comment-text">${comment.commentContent}</p>
                            <p class="comment-date">${new Date(comment.commentDate).toLocaleString()} · ID: ${
                        comment.commentID
                    }${pinnedIcon}</p>
                        </div>
                    </div>
        ...
        .then((tracks) => {
            ...
            tracks.slice(0, 3).forEach((track) => {
                ...
                const truncatedTitle =
                    track.releaseName.length > 10 ? track.releaseName.substring(0, 10) + "..." : track.releaseName
                ...
                moreFromHTML += `
                    ...
                    track.releaseAuthor.authorUsername
                            ...
                            <div class="text">
                                <a href="/track/${track.releaseID}" onclick="visitTrackPage(${
                    track.releaseID
