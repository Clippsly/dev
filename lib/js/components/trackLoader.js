...
Stimulus.register(
    ...
    class extends Controller {
        ...
        createTrack(trackData) {
            ...
            trackCoverImg.loading = 'lazy'
            trackCoverImg.classList.add('skeleton-load-fg')
            trackCoverImg.setAttribute('data-loaddrive-target', 'img')
            ...
            artistPfpImg.src =
                ...
                'https://cdn.clippsly.com/brand_assets/icons/default-artist.png'
            artistPfpImg.loading = 'lazy'
            artistPfpImg.setAttribute('data-loaddrive-target', 'img')
            ...
            artistName.textContent =
                trackData.releaseAuthor.authorDisplay
